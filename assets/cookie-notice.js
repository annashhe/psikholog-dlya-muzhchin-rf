...
(function (global) {
  ...
  function openSettingsModal() {
    ...
    overlay.innerHTML =
      ...
      (analyticsOn ? ' checked' : '') +
      ' />' +
      '<label for="psiCookieAnalytics"><strong>Статистика посещений</strong>Яндекс.Метрика и Google Tag — просмотры страниц и клики. Подробнее — в политике конфиденциальности.</label>' +
      '</div>' +
